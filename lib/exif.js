    ...
    await new Promise((resolve, reject) => {
        ff(tmpFileIn)
            ...
            .addOutputOptions([
                ...
                "libwebp",
                "-vf",
                "scale='min(400,iw)':min'(400,ih)':force_original_aspect_ratio=decrease,fps=15, pad=400:400:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse"
            ])
            .toFormat("webp")
            .save(tmpFileOut)
    })
